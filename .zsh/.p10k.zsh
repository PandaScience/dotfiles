# Generated by Powerlevel10k configuration wizard on 2022-03-25 at 23:05 CET.
...
() {
  ...
  # kubectl
  typeset -g POWERLEVEL9K_ASDF_KUBECTL_FOREGROUND=39
  typeset -g POWERLEVEL9K_ASDF_KUBECTL_VISUAL_IDENTIFIER_EXPANSION='ﴱ'
  typeset -g POWERLEVEL9K_ASDF_KUBECTL_SHOW_ON_UPGLOB='kubeconfig'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|kubecolor|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern'
